(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_8881e7._.js", {
    ...
    const fetchTakeaways = async (url)=>{
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/summarize', {
                ...
                body: JSON.stringify({
                    youtube_url: url,
                    query: "What are the key takeaways and main points discussed in this podcast? Please list them in a clear, organized manner, one in each new line."
                })
            });
            if (!response.ok) {
...
_s(Home, "zgIrtHVHpVGj1EvZF8MY8yUfGiY=", false, function() {
    return [
...
//# sourceMappingURL=_8881e7._.js.map